...
def run_report():
    initial_prompt = (
        ...
        "Você deve: "
        "1. Calcular as métricas chave (taxa de aumento de casos geral em porcentagem , taxa de mortalidade geral , taxa de ocupação de UTI considerando o periodo total ,e taxa de vacinação geral ). "
